...
for file_path in Path(rp.get_export_dir()).glob("assets/minecraft/textures/trims/**/*_resin_*.png"):
    file_path.unlink(missing_ok=True)

for file_path in Path(rp.get_export_dir()).glob("assets/minecraft/textures/trims/**/*_copper_darker_*.png"):
    file_path.unlink(missing_ok=True)
